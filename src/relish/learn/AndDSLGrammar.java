...
public class AndDSLGrammar extends DSLGrammar {

  public AndDSLGrammar() {
    this(null);
  }

  @Deprecated
  public AndDSLGrammar(String grammarFilePath) {
  ...
  private void addProductions() {
    ...
    int cost = 1;
    Production production = new AndDSLSemantics.And(++maxProductionCounter, returnSymbol, operatorName, argumentSymbols, cost);
