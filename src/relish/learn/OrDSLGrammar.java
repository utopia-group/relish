...
public class OrDSLGrammar extends DSLGrammar {
  ...
  @Deprecated
  public OrDSLGrammar(String grammarFilePath) {
  ...
  private void addProductions() {
    ...
    int cost = 1;
    Production production = new OrDSLSemantics.Or(++maxProductionCounter, returnSymbol, operatorName, argumentSymbols, cost);
