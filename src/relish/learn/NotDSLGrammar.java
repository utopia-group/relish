...
public class NotDSLGrammar extends DSLGrammar {

  public NotDSLGrammar() {
    this(null);
  }

  @Deprecated
  public NotDSLGrammar(String grammarFilePath) {
  ...
  private void addProductions() {
    ...
    int cost = 1;
    Production production = new NotDSLSemantics.Not(++maxProductionCounter, returnSymbol, operatorName, argumentSymbols, cost);
